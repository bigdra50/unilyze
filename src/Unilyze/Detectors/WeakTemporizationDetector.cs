...
internal sealed record WeakTemporizationFinding(string MethodName, int Line, string Message);

internal static class WeakTemporizationAnalyzer
{
...
internal sealed class WeakTemporizationSmellDetector : ISmellDetector
{
