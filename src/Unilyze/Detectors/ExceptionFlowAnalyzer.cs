...
internal sealed record CatchAllClause(string MethodName, int Line, bool HasRethrow);
internal sealed record MissingInnerException(string MethodName, string NewExceptionType, int Line);
internal sealed record SystemExceptionThrow(string MethodName, int Line);
